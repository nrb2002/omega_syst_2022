                                ...
                                <div class="mobile-menu" aria-label="Mobile">
                                    ...
                                    <div class="menu-main-menu-container">
                                        <ul id="mobile-primary-menu" class="nav-menu main-menu-modal">
                                            ...
                                            <li id="menu-item-324" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-324"><a href="login">myOmega</a></li>
                    ...
                    <nav id="site-navigation" class="main-navigation" itemscope itemtype="https://schema.org/SiteNavigationElement">
                        <div class="menu-main-menu-container">
                            <ul id="primary-menu" class="menu">
                                ...
                                <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-326"><a href="login">myOmega</a></li>
