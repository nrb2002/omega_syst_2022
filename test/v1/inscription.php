    ...
    if (isset($_POST['forminscription']))
    {
        ...
        if(!empty($_POST['pseudo']) AND !empty($_POST['mail']) AND !empty($_POST['mail2']) AND !empty($_POST['mdp']) AND !empty($_POST['mdp2']) )
        {
            ...
            if ($pseudolength <= 255)
            {
                ...
                $reqpseudo = $bdd->prepare("SELECT * FROM omega_membre WHERE Pseudo = ?");
                ...
                if($pseudoexist == 0)
                {
                    ...
                    if ($mail == $mail2)
                    {
                        ...
                        if(filter_var($mail, FILTER_VALIDATE_EMAIL))
                        {
                            ...
                            $reqmail = $bdd->prepare("SELECT * FROM omega_membre WHERE Email = ?");
                            ...
                            if($mailexist == 0)
                            {
                                ...
                                {
                                    $serreur = "Veuillez vérifier le mot de passe";
                                }
                            }
                    ...
                    {
                        $erreur = "Veuillez vérifier l'adresse email saisie";
                    }
                }
                else
                {
