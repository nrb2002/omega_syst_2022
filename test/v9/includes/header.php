		...
		<div class="container">
			<header id="masthead" class="site-header" itemscope itemtype="https://schema.org/WPHeader">
				<div class="site-branding" itemscope itemtype="https://schema.org/Organization">
		            <div class="text-logo">
                        <h1 class="site-title" itemprop="name"><a href="index" rel="home" itemprop="url">OMEGA System</a></h1>
				        <p class="site-description">Pour un meilleur accompagnement dans le business environnemental</p>
                    </div><!-- .text-logo -->
	            </div><!-- .site-branding -->
                <div class="right">
                                        ...
                                        <ul id="mobile-primary-menu" class="nav-menu main-menu-modal">
                                            ...
                                            <li id="menu-item-344" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-344"><a href="#">Enregistrez-votre business</a>
                                                <ul class="sub-menu">
                                                    ...
                                                    <li id="menu-item-355" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-355"><a href="register">Freelance</a></li>
                                                </ul>
                                            </li>
                                            ...
                                            <li id="menu-item-324" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-324"><a href="my-omega">myOmega</a></li>
                            ...
                            <ul id="primary-menu" class="menu">
                                ...
                                <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-344"><a href="#">Enregistrez-votre business</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-355"><a href="register">Freelance</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-326"><a href="my-omega">myOmega</a></li>
