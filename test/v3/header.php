...
#wpadminbar #wp-admin-bar-wsm_free_top_button .ab-icon:before {
	...
	<title>Accueil - OMEGA System</title>
	<link rel="canonical" href="https://omegasystem.biz/" />
	<meta property="og:locale" content="fr_FR" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="Accueil - OMEGA System" />
        ...
        <main>
            ...
            <!--<header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
                    ...
                    <div class="col-md-3 text-end"> 
                        ...
                        <a href="inscription.php"><button type="button" class="btn btn-primary">S'enregistrer</button></a>
                    </div>
                </header>
			...
			<header id="masthead" class="site-header" itemscope itemtype="https://schema.org/WPHeader">
				<div class="site-branding" itemscope itemtype="https://schema.org/Organization">
		            <div class="text-logo">
				        ...
				        <p class="site-description">Pour une meilleure protection de l&#039;environnement</p>
                    </div><!-- .text-logo -->
	</div><!-- .site-branding -->
    				<div class="right">
...
<li id="menu-item-324" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-324"><a href="#">Rejoindre notre équipe</a>
<ul class="sub-menu">
	...
	<li id="menu-item-354" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-354"><a href="https://omegasystem.biz/demandeurs-demploi/">Formulaire Demandeur d’Emploi</a></li>
</ul>
</li>
</ul></div>                                </div>
                            </div>
                    ...
                    <nav id="site-navigation" class="main-navigation" itemscope itemtype="https://schema.org/SiteNavigationElement">
                        <div class="menu-main-menu-container"><ul id="primary-menu" class="menu"><li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-334"><a href="https://omegasystem.biz/blogs-utilisateurs/">Appels d&#8217;offres</a></li>
...
<ul class="sub-menu">
	...
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-355"><a href="inscription.php">Freelance</a></li>
</ul>
</li>
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-324"><a href="#">Rejoindre notre équipe</a>
<ul class="sub-menu">
	<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-325"><a href="#">Offres d&#8217;emploi</a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-354"><a href="https://omegasystem.biz/demandeurs-demploi/">Formulaire Demandeur d’Emploi</a></li>
</ul>
</li>
