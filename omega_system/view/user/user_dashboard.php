...
<html lang="en">
    ...
    <head>
        ...
        <title>Omega System - Compte Utilisateur</title>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-sm bg-light navbar-light border shadow">
            <div class="container-fluid">
                <span class="navbar-text text-center"><i><?php echo 'Bienvenue, '.$_SESSION['nomuser']; ?></i></span>
