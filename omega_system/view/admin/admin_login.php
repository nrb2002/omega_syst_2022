                            ...
                            <form class="login-form__form border bg-light" method="post" action="index_admin.php">
                                ...
                                <div class="login-form__panel shadow p-4 rounded bg-light" data-animation="slideHorz ">
                                    ...
                                    <div class="login-form__content">
                                        ...
                                        <i style="color: red;"><?php echo  $_SESSION['msg']; ?></i><br>
                                        <h4>Espace Admin</h4>
                                        <hr>
                                        ...
                                        <div class="form-row mt-4">
                                            ...
                                            <div class="col-10 col-sm-7 mt-5 mt-sm-0">
                                                <input class="login-form__input form-control" type="text" name="loginadmin" id="loginadmin" placeholder="Votre identifiant unique" required/>                                        
                                            </div>
                                        </div>
                                        <div class="form-row mt-4">
                                            ...
                                            <div class="col-10 col-sm-7 mt-4 mt-sm-0">
                                                <input class="login-form__input form-control" type="password" name="mdpadm" id="mdpadm" placeholder="**********" required/>
                                            </div>
                                        </div>
                                        <div class="form-row mt-4">
                                            <div class="col-10 col-sm mt-4 mt-sm-0">
